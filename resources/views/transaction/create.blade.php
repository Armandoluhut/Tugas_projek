...
<form action="/transaction/create" method="POST">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <input type="number" class="form-control" required name="qty" id="qty" onkeyup="hitung()">
            </div>
            <div class="form-group col-md-3">
                <label>Price</label>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="number" name="total_purchase" class="form-control" required>
            </div>
            <div class="form-group col-md-6">
                <label>Additional Request</label>
                <textarea name="additional_request" class="form-control" required></textarea>
            </div>
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" readonly name="total_price" id="total_price">
            </div>
